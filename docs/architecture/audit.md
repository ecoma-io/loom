...
| Responsive                | Root suite covers 5/9 layouts at 320/1024/ultrawide; template page-level gate at 320/768; engine conformance for 4/9 compositions; mobile profiles only on infra legs                                                                                                                                                                                                                                                                                                                      | PARTIALLY_ENFORCED — 4 layouts, 5 compositions and all blocks lack browser evidence              | Phase 2                                                   |
