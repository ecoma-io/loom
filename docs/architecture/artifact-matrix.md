...
76 primitives, 9 compositions, 14 patterns, 9 layouts, 3 templates.
...
| --------------------------------------------------- | ---------------------------------------------------------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------- | ------------------------------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| Worked-example pattern pages                        | `docs/patterns/` (`forms.md`, `menus.md`, beside the 14 Pattern pages)                   | `layer-docs`    | Documentation artifact (name collides with the shipped Pattern kind)                                                                                               | Site only | recorded in artifact-model §Relationship    | Naming collision, decided as recorded                                                        | Rides the rename decision                        |
| Component/Composition/Pattern/Layouts docs sections | `docs/components` (76), `docs/composition` (9), `docs/patterns` (16), `docs/layouts` (9) | `layer-docs`    | Documentation artifacts keyed 1:1 to tiers, except `docs/patterns` — its 16 pages are the 14 Pattern pages plus the two worked-example pages the row above carries | Site only | `check-component-artifacts.ts` tier→dir map | `docs/blocks` became `docs/patterns` in 2C; the mapping table previously left these rows out | Renamed in 2C; rows added by this matrix         |
| Showcase                                            | `docs/showcase/` (3 pages)                                                               | `layer-docs`    | Consumer-shaped demonstration                                                                                                                                      | Site only | facade-only imports                         | None                                                                                         | —                                                |
| Demos                                               | `docs/demos/` (110)                                                                      | `layer-docs`    | Documentation artifacts (site-rendered)                                                                                                                            | Site only | demos-a11y sweep imports them               | `@lucide/vue` dependency declared nowhere consumer-visible                                   | Phase 2: declare or document                     |
