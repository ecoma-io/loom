...
features:
  ...
  - title: Motion that means something
    details: Every transition answers a question the user just asked. Presses read as physical, work reads as ongoing, and the whole library collapses to instant under prefers-reduced-motion.
