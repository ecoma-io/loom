...
| The pole regressed              | pole leg sustained > 2× its measured band (≈ 190–200 s) across ≥ 3 consecutive main runs at verified-quiet supply | `timings` JSONL from those runs; then the bench for attribution                           |
