...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: {
      ...
      "@ecoma-io/loom/theme": pkg("loom/src/theme.ts"),
      ...
      // imports). The list mirrors the internal packages that exist — all but
      // one: theme-core has deliberately no alias, because nothing may import
      // it as a package (its stylesheets ship by being copied into
      // dist/styles, never by specifier) — it is not a migration queue, and
      // the docs VitePress config deliberately carries none of it: there the
      // facade's bare-specifier imports resolve through the packages/loom
      ...
      "@ecoma-io/loom-error-summary": pkg("patterns/error-summary/src/index.ts"),
      ...
      "@ecoma-io/loom-empty-state": pkg("patterns/empty-state/src/index.ts"),
      "@ecoma-io/loom-error-state": pkg("patterns/error-state/src/index.ts"),
      "@ecoma-io/loom-form-actions": pkg("patterns/form-actions/src/index.ts"),
      "@ecoma-io/loom-form-section": pkg("patterns/form-section/src/index.ts"),
      "@ecoma-io/loom-loading-state": pkg("patterns/loading-state/src/index.ts"),
      "@ecoma-io/loom-metric-card": pkg("patterns/metric-card/src/index.ts"),
